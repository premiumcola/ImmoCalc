...
export async function laden() {
  ...
  // N394 — „Zähler konfigurieren" ist keine eigene Zeile mehr: sie öffnete
  // denselben Dialog wie die Anfangszählerstände-Karte darunter (seit N390)
  // über einen zweiten Zugang. Eine Karte reicht (siehe `erststandHtml`).
