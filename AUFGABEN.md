...
| CCCXXVII | **Flächen je Einheit differenzierter** — Wohn-/Nutzfläche des Nutzers eintragen, zusätzlich Gemeinschaftsflächen mit **Splitfaktor** (von wie vielen Personen genutzt), um den anteiligen Flächenbeitrag in die Einheitsfläche einzurechnen. | **offen** — Einheit: `wohnflaeche` + Liste Gemeinschaftsflächen (Fläche + Personenzahl) → effektive Fläche = Wohnfläche + Σ(Gemeinschaftsfläche / Personen). Additiv, in Verteilung/Anteil einrechnen |
