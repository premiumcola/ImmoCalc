...
| CCCXLIX | **Cashflow +/- grafisch auf der Objektkachel** (Startseite, oben rechts) — schlicht/verständlich, ohne viel Text/Zahlen. | **offen** — `index.html` Kachel: kleiner +/- Indikator (Ampel/Balken) je Objekt aus dem Jahres-Saldo |
| CCCXLVIII | **Einheiten-Bubble auf der Startseite → direkt in die Einheit** — Klick auf eine Einheit-Blase in der Objektkachel springt direkt in die Einheit-Ebene (`&e=<id>`), nicht nur ins Haus. | **offen** — `index.html` Kachel-Bubbles verlinken auf `objekt.html?o=slug&e=id` |
