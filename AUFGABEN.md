...
| CCCLXII | **Kostenart einer Position umdefinieren** — eine Position (z.B. generische „Versicherung") auf eine andere/spezifischere Kostenart setzen (z.B. „Gebäudeversicherung") — aus den vorhandenen Kostenarten des Objekts wählbar oder umbenennen. | **offen** — `zeitraum.html`: in der Positionskarte die Kostenart wechseln (PATCH `kostenart`); Backend erlaubt bereits Feld-Änderung, Umzug/Konflikt (Zielkostenart existiert) sauber behandeln. NACH CCCLXI |
