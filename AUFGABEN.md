...
| Nr. | In einfachen Worten | Stand |
|---|---|---|
| CCXCVI | **Grundsteuer-Felder: Herkunft + Rechenkette zeigen**: beim Grundstück ist unklar, welcher Wert woher kommt (Grundstückswert vs. Grundsteuerwert; Hebesatz kommt von der Gemeinde, nicht vom Finanzamt). Die Rechnung in der Reihenfolge zeigen, in der sie entsteht: Grundsteuerwert × Steuermesszahl = Steuermessbetrag × Hebesatz = Grundsteuer/Jahr. Fall Eckenhaid ist Grundsteuer A (Land-/Forstwirtschaft): Reinerträge × Kapitalisierungsfaktor → Grundsteuerwert | **offen** — `objekt.html` (GRUNDFELDER-Hinweise + abgeleitete Kette) |
