...
| CCCXIX | **Einmalige Kauferwerbsnebenkosten** (bei allen Immobilien): dritte Belegart neben „Information" und „wiederkehrende Kosten" — **einmalige Erwerbsnebenkosten** (Notar, Grunderwerbsteuer, Grundbuch/Grundschuld, Makler, Gutachter, Sonstiges), gehören zum Kaufvertrag/Erwerb. Erst nur Wert erfassen. Damit: Nebenkosten (wiederkehrend) · Erträge · **einmalige Erwerbsnebenkosten**. Knüpft an CXXXIV/CV an | **offen** — `Zahlung` mit `kategorie="Erwerbsnebenkosten"` + Art-Liste; Zuordnen-Dialog dritte Option |
