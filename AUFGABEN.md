...
| CCCLXXXIII | **Dokumente: nur PDFs anzeigen** — im Eingang/Dokumente nur noch PDF-Dokumente zeigen; alles wird zu PDF gewandelt + OCR. Nicht-PDF (Excel, JPG …) haben keinen Bezug und sollen nicht mehr auftauchen. | **offen** — `eingang.html` (Liste filtern) bzw. Backend-Liste; **berührt eingang.html → nach KI-Agent** (CCCLXXIX) |
