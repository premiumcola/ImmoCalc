...
| CCCXLIV | **Einstellungen-Audit** — alle Menüpunkte prüfen: noch nötig? (Ordner-Struktur/Belege-in-Jahresordner-Einsortierung, Auto-Sortierung aus Hauptordner, Benennung nachziehen, Buttons nötig?); frühe **Dev-/Diagnose-Funktionen** raus, wenn obsolet; **Rechenlogik-Übersicht + Diagramme** aufwerten (sehen basic aus); Icons prüfen, fehlende generieren. | **offen** — `settings.html` + ggf. `docs/rechenlogik.md`, `kostenicons.js`; Research/Audit-Pass, dann umsetzen |
