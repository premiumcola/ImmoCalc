...
| CCCXL | **Button-Flut im Positionseditor aufräumen** — zu viele überlappende „Bestätigen/Verteilung übernehmen/Übernehmen"-Buttons; nach „Verteilung übernehmen" erscheint unten ein **in der Luft hängender** zweiter „Verteilung übernommen"-Button (raus). Ablauf schöner/smarter, nicht 4 Bestätigen-Buttons. | **in Arbeit (Agent)** — `zeitraum.html` |
