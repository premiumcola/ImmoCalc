...
| CCCLXXVI | **Scanner: automatische Kantenerkennung taugt beim Start nicht** — der vorgeschlagene Bereich sitzt anfangs falsch, es muss praktisch immer alles von Hand nachgezogen werden. | **offen** — Kantenerkennung im Browser verbessern (Graustufen + Kontrast/Schwellwert, größtes zusammenhängendes helles Viereck, Ecken robust gegen Heftklammer); Fallback: ganzer Rahmen |
...
| CCCLXXIII | **Falsches Jahr aus Dateinamen (2045)** — der Beleg `204596-00-GPIE….pdf` wurde als Jahr **2045** einsortiert: aus einer längeren Ziffernfolge werden die ersten vier Stellen als Jahr gelesen. | **offen** — Jahres-Erkennung nur bei plausiblem Jahr (ca. 1990 … heute+10) UND wenn die Ziffernfolge nicht Teil einer längeren Zahl ist (Wortgrenze); betrifft die Namens-/Belegauswertung im Backend |
