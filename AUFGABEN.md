...
| CCCXXXII | **Rubrik-Reihenfolge normale Immobilien + Grundschuld-Icon + Ordner/Filter-Abgleich** | **(a)(b) erledigt, (c) Vorschlag geliefert** — (a) Reihenfolge unten: Mieten → Notarverträge → Grundschulden → Erwerbsnebenkosten → Versicherungen → Kredite → Steuer/Finanzamt (verifiziert); (b) Grundschulden mit Icon (Finanzierungs-Symbol) + Hilfe daneben; (c) Ordner↔Rubrik-Gegenüberstellung dem Nutzer vorgelegt — Kern: Cloud-Ordner sind grob (40_Kauf_Eigentum_Finanzierung bündelt Notar/Kredit/Grundschuld/Erwerb), App-Rubriken fein → 1:1-Filter nicht möglich ohne Ordner-Umbau; „01_Allgemein_Hauskonto"↔Versicherungen ist der irreführendste Name. **Wartet auf Nutzer-Entscheidung** |
