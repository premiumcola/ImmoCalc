...
| CCCLX | **Positionskarte-Politur + Netto/Brutto beim Teilbetrag** — Feinschliff nach Nutzer-Feedback: doppelten Tag entfernen, Betrag nur EINmal (oben rechts = Eingabefeld), Vorab-Teilbetrag zuerst und klar „geht weg", „Anpassen"-Klickerei raus (4×25 % bringt nichts), „Beleg anhängen" neben statt unter das PDF, „Fertig"+„Entfernen" nebeneinander, weniger stumpfes Untereinander. Teilbetrag: **Netto eingeben → Brutto (×1,19) live daneben**, Brutto zieht oben ab; §35a getrennter Haken. | **in Arbeit** — Frontend-Redesign `zeitraum.html` (worktree); Backend-Feld `vorab_netto` da (CCCLX Backend, `864f262`) |
