...
| CCC | ~~**Nebenkosten-Bereich für Grundstücke wieder aufnehmen**~~ **erledigt** `27d5141` | Block „Nebenkosten & Grundsteuer" beim Grundstück (Zeitraum anlegen/anzeigen, neutraler Zustand statt § 556-Frist, Erklärfußnote Grundsteuer→Pächter). Zeitraum anlegen + zeitraum.html laden fehlerfrei trotz keiner Einheiten verifiziert |
