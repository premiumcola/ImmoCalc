...
| CCCXXV | **Verkehrswert je Einheit** bei der Hauptimmobilie (Mehrfamilienhaus) — prüfen/ermöglichen, ob der Verkehrswert pro Einzeleinheit angegeben werden kann statt nur je Haus. Autonom entscheiden, was fachlich sinnvoll ist. | **offen** — erst Datenmodell/Engine prüfen (Vermögen je Einheit?), dann entscheiden: je-Einheit-Feld oder Aufteilung nach Anteil/Fläche |
...
| CCCXXVIII | **Quadratmetermiete je Einheit** — €/m² in der Hauptübersicht (Objektseite) und in der Einheitsansicht anzeigen. | **offen** — aus Kaltmiete / effektiver Fläche; je Einheit anzeigen |
