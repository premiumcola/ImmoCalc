...
| CCCXXXIV | **Objektart in der Eigentümer-Übersicht** — je Objekt die Art (Einfamilienhaus, Reihenhaus, Mehrfamilienhaus, Villa, Grundstück …) zeigen; in den Eigentumsverhältnissen **dreigeteilt**: Objektart · Einheit · Adresse (Grundstück: Flurnummer als Adresse), mit abgesetzter Typografie (fett/kursiv/dünn, iPhone-tauglich, ggf. zweizeilig). | **offen** — baut auf vorhandenem `typ`-Feld auf (Villa/MFH/Doppelhaus/Wohnung/Bauernhof/Gewerbe/Grundstück); **Einfamilienhaus + Reihenhaus ergänzen**; `typ`→Label-Map; settings.html Personen-Übersicht dreigeteilt. **Vorschlag zuerst** (Kategorien + Darstellung) |
