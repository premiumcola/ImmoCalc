...
| CCCLIII | **Touch-Targets < 44px (iOS/iPad, kosmetisch)** — aus dem Audit: Logo-Home-Links `a.applogo-link`/`a.barlogo` 34×34 (mehrere Seiten), Fußnav-Textlinks „Nebenkosten"/„Wert & Cashflow" ~15px hoch, `zeitraum.html .scanmini` 39px (Label ab 560px ausgeblendet), `objekt.html .stjahr` 24–29px. | **offen** — niedrige Priorität; klickbare Ziele auf ≥44×44px anheben, ohne die Optik zu stören |
