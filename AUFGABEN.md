...
| CCCLIX | **Teilbetrag einer Position direkt auf eine Einheit — mit §35a/Steuer-Flag, Rest nach Schlüssel** — Bsp: Position 147 €, davon 35 € (mit/ohne Steuer = §35a) direkt auf EINE Einheit, die restlichen 112 € nach Verteilungsschlüssel. Heute geht nur „100 % auf eine Einheit" ODER „ganz nach Schlüssel", kein Teilsplit. | **offen** — additiv: `Kostenposition.vorab_betrag/vorab_einheit/vorab_s35` (Default 0/""/False → Bestand unverändert); Engine verteilt Vorab-Betrag 100 % auf die Einheit (eigenes §35a), Rest (Betrag−vorab) nach `anteile`; Referenztests grün halten, PDF/Abrechnung anpassen; UI-Steuerung in der neuen schlanken Positionskarte |
