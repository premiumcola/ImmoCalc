...
| CCCLXXXIV | **Jahr besser aus Dateierstellungsdatum ableiten** — statt (nur) aus dem Dateinamen das Datei-Erstellungs-/Änderungsdatum heranziehen; dann entstünde ein Unsinns-Jahr wie 2045 gar nicht erst. | **offen** — Backend (Dokument-Import/OCR): Datei-Metadaten (mtime) als Jahres-Quelle, Namensjahr nur wenn plausibel. Ergänzt CCCLXXIII |
