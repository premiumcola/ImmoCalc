...
| CCCXXIV | **Eintrag umklassifizieren** — einen bestehenden Eintrag in eine andere Rubrik verschieben, speziell Notarvertrag/Sonstiges → **einmalige Erwerbsnebenkosten** (Beispiel: „Kaufvertrag" ist eigentlich die Notargebühren-Rechnung). Umbenennen geht über „Art"; die Rubrik-Änderung fehlt noch. | **offen** — Detail-/Edit-Ansicht: „Rubrik ändern" → Eintrag samt Belegen (quelle + info_zu) in die Zielrubrik überführen (modellübergreifend), Quelle löschen; Backend-Endpunkt nötig |
