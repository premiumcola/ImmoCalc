...
| CCCLXVIII | **Mietvertrag direkt am Mietverhältnis scannen** — hängt an einem Mietverhältnis noch kein Dokument, steht im Dokumentenbaum nur „noch kein Beleg hinterlegt"; anhängen geht nur oben. Gewünscht: direkt dort abfotografieren. Muss durch die normale Dokumentenpipeline: **mehrseitig**, als PDF, klein komprimiert, OCR, gedreht, sinnvoll gecropt — auch bei Heftklammer/nicht perfekt rechteckigem Blatt. Kontrast sorgt der Nutzer selbst (weiß auf weiß muss nicht funktionieren). | **offen** — Erkundung läuft; Infrastruktur teils vorhanden (`public/assets/scan.js`, `api/app/ocr.py`, Dokumenten-Router, Nextcloud-Ablage) |
