...
| CCCI | **Nießbrauch als aktivierbarer Block**: Nießbrauch an/aus schalten; ist er aus, sind die übrigen Nießbrauch-Felder ausgeblendet. **Berechtigter** aus den vorhandenen Eigentümern wählbar (Dropdown), nicht Freitext | **offen** — `objekt.html` (STAMMFELDER, Eigentümerliste) |
