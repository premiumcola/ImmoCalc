...
| CCCLXXXIII | ~~**Dokumente: nur PDFs anzeigen**~~ **erledigt** — `eingang.html` `zeichne()` filtert die Liste auf `*.pdf`; Fremdformate (csv/xlsx/jpg) erscheinen nicht mehr. Live geprüft: von 437 nur die 245 PDFs gerendert, 0 Fehler. **Klein offen:** der Kopf-Zähler („X von Y") zählt noch alle Typen — kosmetisch. |
