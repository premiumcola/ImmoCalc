...
| CCCIII | **Grundstück-Ertrag direkt rechnen (statt NK-Bereich)**: den NK-/Zeitraum-Block beim Grundstück wieder entfernen. Aus den Grunddaten direkt zeigen: **NK-Höhe = Grundsteuer/Jahr** (Messbetrag × Hebesatz) und **Ertrag/Jahr = Pacht/Jahr − Grundsteuer/Jahr** | **offen** — `objekt.html` (zeitraumBlock wieder aus, Ertragsrechnung im Grundstücksblock) |
