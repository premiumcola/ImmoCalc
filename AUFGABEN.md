...
| CCCXXXVII | **`objekt.html` modularisieren** — die riesige Datei aufteilen, damit künftig besser (auch parallel) daran gearbeitet werden kann. | **offen** — NACH den aktuellen Aufgaben, ggf. „über Nacht"; Nutzer gibt es später frei. objekt.html ist der Flaschenhals fast aller Features |
