...
| CCCXLIII | **Lexikon-Vollständigkeit + Info-Marks überall** — alle Menüs/Bearbeitungsansichten nach Begriffen durchsuchen, die im Lexikon fehlen oder falsch sortiert sind; ergänzen/pflegen, und an den entsprechenden Stellen (Bearbeiten + normale Ansicht) Info-Marks (?) setzen, die aufs Lexikon verlinken. | **offen** — Research-Pass über alle HTML + `lexikon-daten.js`; `lex:`/`data-hilfe` konsistent setzen |
