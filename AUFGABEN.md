...
| CCCLXXI | **„Aus Ablage" akzeptiert nur Bilder — PDFs fehlen** — im Datei-Dialog steht der Filter „Bilddateien (*.tif;*.jfif;…)", PDF-Ordner erscheinen dadurch leer; Belege sind aber meist PDF. | **offen** — `accept` im Datei-Input um PDF erweitern (`.pdf,application/pdf` + Bilder), Upload-/Pipeline-Weg prüft ohnehin den Typ |
