...
| CCCXIX | **Einmalige Kauferwerbsnebenkosten** (bei allen Immobilien): dritte Belegart neben „Information" und „wiederkehrende Kosten" — **einmalige Erwerbsnebenkosten** (Notar, Grunderwerbsteuer, Grundbuch/Grundschuld, Makler, Gutachter, Sonstiges), gehören zum Kaufvertrag/Erwerb. Erst nur Wert erfassen. Damit: Nebenkosten (wiederkehrend) · Erträge · **einmalige Erwerbsnebenkosten**. Knüpft an CXXXIV/CV an | **(a) erledigt, (b) offen** — (a) neue Rubrik „Einmalige Erwerbsnebenkosten" bei allen Objekten (nach Pacht/Erträgen), Werteingabe über `Zahlung` mit fester `kategorie="Erwerbsnebenkosten"` + `turnus="einmalig"`, Art-Auswahl (Notar/Grunderwerbsteuer/Grundbuch/Makler/Gutachter/Sonstiges) mit Vorgabe, aus den Finanzamt-Zahlungen herausgesplittet. Add/Edit/Detail/Delete über den geteilten Zahlungs-Endpunkt (`RUBRIK_ENDPUNKT`/`RUBRIK_FESTWERTE`). Round-Trip + Leer-Art-Fix verifiziert. (b) **offen:** Zuordnen-Dialog dritte Belegart (braucht Backend-Bauplan `kategorie=Erwerbsnebenkosten`) |
