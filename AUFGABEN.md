...
| CCLX | **Dokument-Karte im Eingang sauber zuklappen**: Kopfzeile antippen klappt die aufgeklappte Karte wieder zu; das karten-schließende × gehört nach **oben** in die Kopfzeile, nicht unten in die PDF-Vorschau | **in Arbeit** (Agent) — `eingang.html` |
