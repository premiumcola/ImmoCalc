...
| CCCIV | **Grundstück: Rubriken sortieren, umbenennen, Icons**: logische Reihenfolge — **Notarverträge → Finanzamt (statt „Steuer & Zahlungen") → Pacht & Erträge (statt „Pacht & Pächter")**; jede Rubrik bekommt ein Icon | **offen** — `objekt.html` (Render-Reihenfolge, BEREICHE-Titel, Sektions-Icons) |
