...
| CCCXXXIII | **Miete aus Flächen × €/m² herleiten** — je Flächenart der **Einheit** (Wohn-/Nutzfläche, Nebenflächen, Gemeinschaftsflächen) einen **€/m²-Mietpreis** eintragen. Flächen + €-Werte gehören zur **Einheit** (nicht zum Mietverhältnis); das Mietverhältnis referenziert sie und daraus ergibt sich der Mietpreis. **Mietpreis selbst NICHT auf der Einheit** (sonst passt er nicht zum Mietverhältnis). | **offen** — Einheit: je Fläche(nart) ein €/m²-Feld; Miete-Berechnung = Σ(Fläche × €/m²); im Mietverhältnis als hergeleitete Kaltmiete (überschreibbar?). Konzept mit Nutzer schärfen |
