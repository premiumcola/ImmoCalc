...
| CCCXXXII | **Rubrik-Reihenfolge normale Immobilien + Grundschuld-Icon + Ordner/Filter-Abgleich** | **offen** — (a) sinnvolle Reihenfolge unten (Notarverträge → Grundschulden → einmalige Erwerbsnebenkosten → Versicherungen → Kredite → Steuer/Finanzamt; **nicht** Versicherung zuerst); (b) Grundschulden bekommt ein Icon; (c) **Vorschlag zuerst**: Gegenüberstellung Cloud-Ordnerstruktur ↔ Rubrik-Filter, wo Namen/Zuordnung nicht passen (Beispielobjekt Laufer Str. 5) |
