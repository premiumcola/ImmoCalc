...
| CCLV | **Kostenfreie Belege** (SEPA-Mandat, Zählerstände/Ableseergebnisse): korrekt benennen, ablegen, klassifizieren — **keine** Kostenposition. Sie sollen als **kleiner Anhang** („Kleideranhänger“) am **übergeordneten Kostenart-Thema** (Wasser-Abrechnung, Müll-Abrechnung) hängen, **nicht** an einer einzelnen Kostenposition — beim Tausch der Position dürfen sie **nicht** verschwinden. Dezent klein anzeigen, nicht groß | **offen** — heute: abgelegt + klassifiziert, keine Position. Anhängen an Kostenart-Thema (objekt+kostenart bzw. zeitraum+kostenart statt `position_id`) noch nicht gebaut |
...
| CCLVII | **Eigentümeranteile schneller zuweisen**: (a) Klick auf eine **orange Verteilungs-Karte** (Objekt mit fehlenden ‰) öffnet direkt die Zuweisungs-Maske, vorbelegt auf dieses Objekt. (b) Im Eingabepanel die **noch verfügbaren ‰** anzeigen und darauf begrenzen statt immer 1000 (z. B. „noch 333,4 ‰ frei“). (c) **Schnellwahl** für die häufigen Fälle — ½ (500 ‰), ⅓ (333,3 ‰) als Buttons/Schieber; die genaue Tausendstel-Eingabe nur als Notfall/Detail | **offen** — `eigentuemer.html`, Anteils-Zuweisung läuft heute über die Objektseite mit fester 1000-Basis |
