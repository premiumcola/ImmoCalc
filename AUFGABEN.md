...
| CCCLXVII | **Startseite: vermietete Einheiten hellgrün mit Miete** — auf der Hauptseite sind vermietete Einheiten-Bubbles heute weiß, freie orange. Vermietete sollen **hellgrün** sein und **Miete** zeigen (Quadratmeter + €/m²-Miete). Freie bleiben orange mit „frei". | **offen** — `index.html` `bubble()`/CSS; Mietwert je Einheit muss im `/api/objekte`-Payload liegen (ggf. additiv ergänzen) |
