...
STANDARD_UNTERORDNER = {
    ...
    # beim Ablegen direkt mitgegeben (`renovierung.projektordner`). Hier steht
    # deshalb die leere Vorlage: ohne Projektbezug bleibt die Datei im
    # Sachordner statt in einem falschen Jahresordner zu landen.
    "Renovierung": "",
    "Sonstiges": "",
}
